...
namespace Web.Areas.CompanyManager.Models
{
    public class PaginationInfoViewModel
    {
        ...
        public int TotalPages => (int)Math.Ceiling((double)TotalItems / Constants.Constants.ITEMS_PER_PAGE);

        public bool HasPrevious => PageId > 1;

        public bool HasNext => PageId < TotalPages;

        public int RangeStart => (PageId - 1) * Constants.Constants.ITEMS_PER_PAGE + 1;
